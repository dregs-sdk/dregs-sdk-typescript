 ...
 *
 * The webhook helpers get their own entry so a webhook receiver can import `dregs/webhooks`
 ...
 * `dregs/webhooks` fails an `instanceof` check against the one exported from `dregs`. The
